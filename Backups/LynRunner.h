...
@class LynRunnerApplication, LynRunnerDocument, LynRunnerWindow, LynRunnerRunner;
...
// LynRunner Document
@interface LynRunnerDocument (LynRunnerSuite)

@property (copy, readonly) LynRunnerRunner *runner;  // The executing runner.
@property (copy, readonly) id project;  // The executed Project.

@end

// LynRunner
@interface LynRunnerRunner : SBObject
